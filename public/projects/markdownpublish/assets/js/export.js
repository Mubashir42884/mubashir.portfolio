...
*{box-sizing:border-box}body{margin:0;background:#f1f2f2;color:var(--ink);font-family:${previewFont};line-height:1.7}.document{width:min(900px,calc(100% - 32px));margin:32px auto;padding:54px 64px 72px;background:var(--paper);box-shadow:0 10px 34px rgba(0,0,0,.08)}h1,h2,h3,h4,h5{page-break-after:avoid}h1{font-size:2rem}h2{margin-top:2rem;border-bottom:1px solid var(--line);padding-bottom:.3rem}a{color:#526b5a}blockquote{margin:1.2rem 0;padding:.15rem 1rem;border-left:3px solid #738b7b;background:#edf2ee;color:#555}table{width:100%;border-collapse:collapse;margin:1.3rem 0}th,td{border:1px solid var(--line);padding:.55rem .65rem;text-align:left;vertical-align:top}th{background:var(--soft)}pre{padding:1rem;border:1px solid var(--line);border-radius:8px;background:var(--soft);overflow:auto}code{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}img{max-width:100%;height:auto;display:block;margin:1rem auto}.page-break{height:0;page-break-after:always;break-after:page}.mdp-spacer{display:block;width:100%}hr{border:0;border-top:1px solid var(--line);margin:2rem 0}.running-header,.running-footer{display:none}
${customCss || ''}
${mathStyles || ''}
